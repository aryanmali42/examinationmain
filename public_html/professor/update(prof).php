  ...
  <div class="formm">
    <form action="<?php $_PHP_SELF ?>" method="post" class="form-group">
      ...
      <div style="padding:5px" class="div">
        ...
        <label style=" class=" radio-inline"><input type="radio" name="ecm" value="yes" <?php if ($ecm === 'yes') {
          echo 'checked';
        } ?>>Yes</label>
        <label style="class=" radio-inline"><input type="radio" name="ecm" value="no" <?php if ($ecm === 'no') {
          echo 'checked';
        } ?>>No</label>
